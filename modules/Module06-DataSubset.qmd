...
This is data based on a simulated measles IgG serological survey.  The rows represent individuals.  Variables include measles-specific IgG concentrations based on EIA, age in years, gender, and residence based on slum characterization.  We will use this dataset for lectures throught the Workshop.
