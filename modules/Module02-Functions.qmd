...
**But, how do you know the purpose of a function and what arguments a function includes and how to specify the arguments?**
...
xxzane - i want to be to view the whole help file (i.e., scroll down in the slide deck) and now have it look weird (i.e., spaces between letters)

```{r, echo = FALSE, results = "asis"}
help_console("round", format="text", lines=0:127, before = "", after = "")
```
...
```{r, echo = FALSE, results = "asis"}
help_console("round", format="text", lines=36:45, before = "", after = "")
```
