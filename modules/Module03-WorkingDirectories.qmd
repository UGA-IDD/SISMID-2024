...
## Absoluate vs. relative paths (From Wiki)
...
-   By contrast, a **relative path starts from some given working directory**, avoiding the need to provide the full absolute path. A filename can is considered as a relative path based on the current working directory.

## Relative path

You want to set you code up based on relative paths.  This allows sharing of code, and also, allows you to modify your own file structure (above of the working directory) without breaking your own code.
